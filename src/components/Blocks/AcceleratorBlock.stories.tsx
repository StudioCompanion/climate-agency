...
const fixtures: StoryFixtures<typeof AcceleratorBlock> = {
  default: {
    ...
    firstContent: `We believe many climate projects need help in terms of business positioning, marketing, and stakeholder strategy. These are fundamentals that can truly help climate projects scale up. `,
    subtitle: `An intense workshop spread over 2 half days.`,
    secondContent: `With elements of business positioning, marketing, behavioural science and stakeholders strategy, with a dash of creativity to inspire you. Plus our very own recommendation tailored to your needs, to help you gain profile and support, landing on your desk within days.

    As a non profit dedicated to help climate innovation, we have worked hard to deliver
    a process which is: 
